...
void print_parameters(const lbcrypto::CryptoContext<lbcrypto::DCRTPoly>& context) {
    /*
    ...
    */
    ...
    std::cout << "|   poly_modulus_degree: "
                << context->GetCryptoParameters()->GetElementParams()->GetRingDimension()<< std::endl;
    ...
    */
    ...
    auto coeff_modulus = context->GetCryptoParameters()->GetElementParams()->GetParams();
    ...
    std::cout << "log2 q = " << context->GetElementParams()->GetModulus().GetMSB() << std::endl;
    ...
    */
    if (schemeID == lbcrypto::BFVRNS_SCHEME) {
        std::cout << "|   plain_modulus: "
                << context->GetCryptoParameters()->GetPlaintextModulus() << std::endl;
    }
    std::cout << "\\" << std::endl;
  }
