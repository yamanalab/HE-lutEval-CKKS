...
using Plaintext2d = vector2d<lbcrypto::Plaintext>;
using Plaintext3d = vector3d<lbcrypto::Plaintext>;
using Plaintext4d = vector4d<lbcrypto::Plaintext>;

using Ciphertext2d = vector2d<lbcrypto::Ciphertext<lbcrypto::DCRTPoly>>;
